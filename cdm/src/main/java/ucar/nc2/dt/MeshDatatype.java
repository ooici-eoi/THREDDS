 ...
 * @author Kyle
 */
public interface MeshDatatype extends Comparable<MeshDatatype> {
  ...
  public MeshDatatype makeSubset(Range rt_range, Range e_range, Range t_range, Range z_range, Range y_range, Range x_range) throws ucar.ma2.InvalidRangeException;
   */
  
  /**
   * Create a new MeshGrid that is a logical subset of this MeshGrid.
   * For backwards compatibility for grids with no runtime or ensemble dimensions.
   *
   * @param t_range  subset the time dimension, or null if you want all of it
   * @param z_range  subset the vertical dimension, or null if you want all of it
   ...
   * @return subsetted MeshGrid
   * @throws ucar.ma2.InvalidRangeException if ranges are invlaid
   
  public MeshDatatype makeSubset(Range t_range, Range z_range, LatLonRect bbox, int z_stride, int y_stride, int x_stride) throws InvalidRangeException;
   */
